...
// ScriptStruct GameFramework.GameCrowdInteractionPoint.GHM_GameCrowdInteractionPoint_CheckpointRecord
// 0x0004
struct FGHM_GameCrowdInteractionPoint_CheckpointRecord
{
...
struct FAICmdHistoryItem
{
	...
	struct FDouble                                     TimeStamp;                                     // 0x0008 (0x0008) [0x0000000000000000]               
	class FString                                      VerboseString;                                 // 0x0010 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
struct FRecentInteraction
{
	...
	struct FDouble                                     InteractionDelay;                              // 0x0008 (0x0008) [0x0000000000000000]               
};
...
struct FPlayerState
{
	...
	struct FDouble                                     TimeSpawned;                                   // 0x0008 (0x0008) [0x0000000000000000]               
	struct FDouble                                     TimeAliveSinceLastDeath;                       // 0x0010 (0x0008) [0x0000000000000000]               
};
...
struct FTouchData
{
	...
	struct FDouble                                     LastActiveTime;                                // 0x004C (0x0008) [0x0000000000000000]               
};
...
// ScriptStruct GameFramework.MobileTouchInputVolume.GHM_MobileTouchInputVolume_CheckpointRecord
// 0x0004
struct FGHM_MobileTouchInputVolume_CheckpointRecord
{

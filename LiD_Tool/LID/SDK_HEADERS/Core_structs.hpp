...
struct FSQWord
{
	...
	int32_t                                            B;                                             // 0x0004 (0x0004) [0x0000000000001001] (CPF_Edit | CPF_Native)
};
...
struct FUntypedBulkData_Mirror
{
	...
	int32_t                                            BulkDataOffsetInFileDummy;                     // 0x0014 (0x0004) [0x0000000000001002] (CPF_Const | CPF_Native)
	int32_t                                            BulkDataSizeOnDisk;                            // 0x0018 (0x0004) [0x0000000000001002] (CPF_Const | CPF_Native)
	int32_t                                            BulkDataSizeOnDiskDummy;                       // 0x001C (0x0004) [0x0000000000001002] (CPF_Const | CPF_Native)
	...
	int32_t                                            SavedBulkDataOffsetInFile;                     // 0x0028 (0x0004) [0x0000000000001002] (CPF_Const | CPF_Native)
	int32_t                                            SavedBulkDataOffsetInFileDummy;                // 0x002C (0x0004) [0x0000000000001002] (CPF_Const | CPF_Native)
	int32_t                                            SavedBulkDataSizeOnDisk;                       // 0x0030 (0x0004) [0x0000000000001002] (CPF_Const | CPF_Native)
	int32_t                                            SavedBulkDataSizeOnDiskDummy;                  // 0x0034 (0x0004) [0x0000000000001002] (CPF_Const | CPF_Native)

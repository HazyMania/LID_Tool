...
// Function GFxUI.GFxMoviePlayer.SetSleep
// [0x00020002] (FUNC_RequiredAPI | FUNC_Public | FUNC_AllFlags)
// Parameter info:
// unsigned long                  flag                           (CPF_Parm)

void UGFxMoviePlayer::SetSleep(unsigned long flag)
{
	static UFunction* uFnSetSleep = nullptr;

	if (!uFnSetSleep)
	{
		uFnSetSleep = UFunction::FindFunction("Function GFxUI.GFxMoviePlayer.SetSleep");
	}

	UGFxMoviePlayer_execSetSleep_Params SetSleep_Params;
	SetSleep_Params.flag = flag;

	this->ProcessEvent(uFnSetSleep, &SetSleep_Params, nullptr);
};

// Function GFxUI.GFxMoviePlayer.IsSleep
// [0x00020002] (FUNC_RequiredAPI | FUNC_Public | FUNC_AllFlags)
// Parameter info:
// bool                           ReturnValue                    (CPF_Parm | CPF_OutParm | CPF_ReturnParm)

bool UGFxMoviePlayer::IsSleep()
{
	static UFunction* uFnIsSleep = nullptr;

	if (!uFnIsSleep)
	{
		uFnIsSleep = UFunction::FindFunction("Function GFxUI.GFxMoviePlayer.IsSleep");
	}

	UGFxMoviePlayer_execIsSleep_Params IsSleep_Params;

	this->ProcessEvent(uFnIsSleep, &IsSleep_Params, nullptr);

	return IsSleep_Params.ReturnValue;
};

// Function GFxUI.GFxMoviePlayer.ClearFixedRenderTextureViewport
// [0x00020002] (FUNC_RequiredAPI | FUNC_Public | FUNC_AllFlags)
// Parameter info:

void UGFxMoviePlayer::ClearFixedRenderTextureViewport()
{
	static UFunction* uFnClearFixedRenderTextureViewport = nullptr;

	if (!uFnClearFixedRenderTextureViewport)
	{
		uFnClearFixedRenderTextureViewport = UFunction::FindFunction("Function GFxUI.GFxMoviePlayer.ClearFixedRenderTextureViewport");
	}

	UGFxMoviePlayer_execClearFixedRenderTextureViewport_Params ClearFixedRenderTextureViewport_Params;

	this->ProcessEvent(uFnClearFixedRenderTextureViewport, &ClearFixedRenderTextureViewport_Params, nullptr);
};

// Function GFxUI.GFxMoviePlayer.SetFixedRenderTextureViewport
// [0x00020002] (FUNC_RequiredAPI | FUNC_Public | FUNC_AllFlags)
// Parameter info:
// int32_t                        W                              (CPF_Parm)
// int32_t                        H                              (CPF_Parm)

void UGFxMoviePlayer::SetFixedRenderTextureViewport(int32_t W, int32_t H)
{
	static UFunction* uFnSetFixedRenderTextureViewport = nullptr;

	if (!uFnSetFixedRenderTextureViewport)
	{
		uFnSetFixedRenderTextureViewport = UFunction::FindFunction("Function GFxUI.GFxMoviePlayer.SetFixedRenderTextureViewport");
	}

	UGFxMoviePlayer_execSetFixedRenderTextureViewport_Params SetFixedRenderTextureViewport_Params;
	memcpy_s(&SetFixedRenderTextureViewport_Params.W, 0x4, &W, 0x4);
	memcpy_s(&SetFixedRenderTextureViewport_Params.H, 0x4, &H, 0x4);

	this->ProcessEvent(uFnSetFixedRenderTextureViewport, &SetFixedRenderTextureViewport_Params, nullptr);
};
...
void UGFxMoviePlayer::SetVariable(class FString Path, struct FASValue Arg)
{
	...
	memcpy_s(&SetVariable_Params.Arg, 0x20, &Arg, 0x20);
...
void UGFxObject::SetElementMember(int32_t Index, class FString Member, struct FASValue Arg)
{
	...
	memcpy_s(&SetElementMember_Params.Arg, 0x20, &Arg, 0x20);
...
void UGFxObject::SetElement(int32_t Index, struct FASValue Arg)
{
	...
	memcpy_s(&SetElement_Params.Arg, 0x20, &Arg, 0x20);
...
void UGFxObject::Set(class FString Member, struct FASValue Arg)
{
	...
	memcpy_s(&Set_Params.Arg, 0x20, &Arg, 0x20);
...
void UGFxClikWidget::SetListener(class UGFxObject* O, class FString Member, struct FScriptDelegate Listener)
{
	...
	memcpy_s(&SetListener_Params.Listener, 0x10, &Listener, 0x10);
...
void UGFxClikWidget::AddEventListener(struct FName Type, struct FScriptDelegate Listener, unsigned long useCapture, int32_t listenerPriority, unsigned long useWeakReference)
{
	...
	memcpy_s(&AddEventListener_Params.Listener, 0x10, &Listener, 0x10);
...
void UGFxClikWidget::EventListener(struct FEventData Data)
{
	...
	memcpy_s(&EventListener_Params.Data, 0x34, &Data, 0x34);

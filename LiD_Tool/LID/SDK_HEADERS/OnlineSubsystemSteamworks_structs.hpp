...
// ScriptStruct OnlineSubsystemSteamworks.OnlineSubsystemSteamworks.SteamDLCInfo
// 0x0018
struct FSteamDLCInfo
{
	int32_t                                            AppID;                                         // 0x0000 (0x0004) [0x0000000000000000]               
	unsigned long                                      bAvailable : 1;                                // 0x0004 (0x0004) [0x0000000000000000] [0x00000001] 
...
struct FLeaderboardEntry
{
	...
	TArray<int32_t>                                    LeaderboardData;                               // 0x0010 (0x0010) [0x0000000000400000] (CPF_NeedCtorLink)
};
...
struct FPendingPlayerStats
{
	...
	class FString                                      PlayerName;                                    // 0x0008 (0x0010) [0x0000000000400002] (CPF_Const | CPF_NeedCtorLink)
	class FString                                      StatGuid;                                      // 0x0018 (0x0010) [0x0000000000400002] (CPF_Const | CPF_NeedCtorLink)
	...
	class FString                                      Place;                                         // 0x0048 (0x0010) [0x0000000000400002] (CPF_Const | CPF_NeedCtorLink)
};

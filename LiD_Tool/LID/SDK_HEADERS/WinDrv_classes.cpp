...
void UHttpRequestWindows::Clean()
{
	static UFunction* uFnClean = nullptr;

	if (!uFnClean)
	{
		uFnClean = UFunction::FindFunction("Function WinDrv.HttpRequestWindows.Clean");
	}

	UHttpRequestWindows_execClean_Params Clean_Params;

	uFnClean->FunctionFlags |= ~0x400;

	this->ProcessEvent(uFnClean, &Clean_Params, nullptr);
...
void UHttpResponseWindows::Clean()
{
	static UFunction* uFnClean = nullptr;

	if (!uFnClean)
	{
		uFnClean = UFunction::FindFunction("Function WinDrv.HttpResponseWindows.Clean");
	}

	UHttpResponseWindows_execClean_Params Clean_Params;
